...
const BASE_STEPS = Object.freeze([
  ...
  ['grill.place.1', '첫 꼬치 올리기', 'SCR-SVC-GRILL', 'grillWaitTray', '네기마를 눌러 1번 칸에 올리세요. 놓는 즉시 앞면 조리가 시작됩니다.'],
  ['grill.place.2', '둘째 꼬치 올리기', 'SCR-SVC-GRILL', 'grillWaitTray', '두 번째 네기마를 2번 칸에 올리세요. 첫 꼬치와 별도로 조리가 시작됩니다.'],
  ...
  ['grill.retrieve.1', '첫 꼬치 꺼내기', 'SCR-SVC-GRILL', 'grill-slot-priority', '양면이 다 익은 꼬치를 눌러 그릴에서 꺼내세요.'],
  ['grill.retrieve.2', '둘째 꼬치 꺼내기', 'SCR-SVC-GRILL', 'grill-slot-priority', '남은 꼬치를 눌러 그릴에서 꺼내세요.'],
