...
import { createProductionRenderer } from '../../presentation/three/productionRenderer.js';
import { createStationDirector } from '../../application/gameplay/stationDirector.js';
import { createD1RawNegimaCompositor } from '../../presentation/three/d1RawNegimaCompositor.js';
import {
  D2_MOMO_RUNTIME_URLS,
  loadD2MomoSpriteRuntime,
} from '../../presentation/three/d2MomoSpriteRuntime.js';
import {
  COOK_SLOT_NEXT_ACTION,
  createD1CookStations,
} from '../../application/gameplay/cookStations.js';
import { createDrinkPour, DRINK } from '../../application/gameplay/drinkStation.js';
import { drinkLeverZoneForDelta } from '../../presentation/ui/drinkLeverDrag.js';
import { createBeerLiquidMaterial } from '../../presentation/three/beerLiquidMaterial.js';
import { createBeerCoreVfxMaterial } from '../../presentation/three/beerCoreVfxMaterial.js';
import { createGrillMaterial } from '../../presentation/three/grillMaterial.js';
import { elapsedSecToUniform } from '../../presentation/three/grillRenderer.js';
import { createGrillSmokeVfx } from '../../presentation/three/grillSmokeVfx.js';
import { d1SecondFaceR3Params } from '../../presentation/three/d1SecondFaceR3.js';
import { createPreparedDock } from '../../presentation/ui/preparedDock.js';
...
import { createCustomerAdapter } from '../../presentation/ui/customerAdapter.js';
import { seatHasServedMenu } from '../../application/gameplay/seatServing.js';
import { settlementStepDetail } from '../../presentation/ui/settlementSteps.js';
import { recipeBookEntries, shouldShowAssemblyTutorial } from '../../application/gameplay/recipeBook.js';
import {
  d1OfficeCustomerVariant,
  isD1OfficeBeerFrame,
  resolveD1OfficeCustomerFrame,
} from '../../presentation/ui/d1OfficeCustomerArt.js';
import {
  isD1SoloBeerFrame,
  resolveD1SoloCustomerFrame,
} from '../../presentation/ui/d1SoloCustomerArt.js';
import {
  SCREENS,
  SCREEN_IDS,
  SCREEN_BY_ID,
